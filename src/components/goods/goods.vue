  ...
  <div>
    <div class="goods">
      <div class="menu-wrapper" ref="menuWrapper">
        <ul>
          <li class="menu-item" v-for="(item, index) in goods" :key="item.id" :class="{'current':currentIndex===index}" @click="selectMenu(index,$event)" ref="menuList">
            ...
            <ul>
              <li class="food-item border-1px" @click="selectFood(food,$event)" v-for="food in item.foods">
                ...
                <div class="content">
                  ...
                  <div class="extra">
                    <span class="count">{{food.sellCount}}月售份</span><span>好评率{{food.rating}}%</span>
                  </div>
                  <div class="price">
